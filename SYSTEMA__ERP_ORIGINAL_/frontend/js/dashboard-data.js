...
class DashboardData {
  ...
  async getPrevisaoVendas() {
    try {
      ...
      if (!response.ok) {
        throw new Error('Erro ao buscar previsão de vendas');
      }
  ...
  async getRecomendacoesEstoque() {
    try {
      ...
      if (!response.ok) {
        throw new Error('Erro ao buscar recomendações de estoque');
      }
      return await response.json();
    } catch (error) {
  ...
  async getOtimizacaoPrecos() {
    try {
      ...
      if (!response.ok) {
        throw new Error('Erro ao buscar otimização de preços');
      }
      return await response.json();
    } catch (error) {
